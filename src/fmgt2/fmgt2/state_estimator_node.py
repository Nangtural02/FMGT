...
class StateEstimatorNode(Node):
    def __init__(self):
        ...
        # ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
        # 발행자 토픽 이름을 'relative_position'으로 통일합니다.
        # ★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
        self.publisher_ = self.create_publisher(PointStamped, 'relative_position', 10)
        
        self.x = np.zeros(4)
        self.P = np.eye(4) * 100.0
        accel_std_dev = 0.5
        self.Q = np.diag([0.0, 0.0, accel_std_dev**2, accel_std_dev**2])
        measurement_std_dev = 0.1
        self.R = np.eye(2) * (measurement_std_dev**2)
